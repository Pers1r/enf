...
from .forms import CustomUserLoginForm, CustomUserCreationForm, CustomUserUpdateForm
...
def register(request):
    # when user inputs data and confirm then Post and new user creation
